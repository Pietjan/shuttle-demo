// Module tools exists only to pin the command-line tools this repository
// builds with, so their dependency trees stay out of the app's own go.mod.
// Nothing imports it and it ships no code.
//
// The templ pin matters more than the others: generated code is written
